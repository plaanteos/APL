...
-- Cliente
CREATE INDEX IF NOT EXISTS idx_cliente_id_administrador ON cliente(id_administrador);
...
CREATE INDEX IF NOT EXISTS idx_pedidos_id_administrador ON pedidos(id_administrador);
...
CREATE INDEX IF NOT EXISTS idx_pedidos_fecha_delete ON pedidos(fecha_delete);

-- Producto
CREATE INDEX IF NOT EXISTS idx_producto_id_administrador ON producto(id_administrador);
...
CREATE INDEX IF NOT EXISTS idx_detalle_pedidos_id_estado ON detalle_pedidos(id_estado);

-- Estado
CREATE INDEX IF NOT EXISTS idx_estado_fecha_delete ON estado(fecha_delete);

-- Pago
CREATE INDEX IF NOT EXISTS idx_pago_id_administrador ON pago(id_administrador);

-- Detalle pago
CREATE INDEX IF NOT EXISTS idx_detalle_pago_id_pedido ON detalle_pago(id_pedido);
CREATE INDEX IF NOT EXISTS idx_detalle_pago_id_pago ON detalle_pago(id_pago);
CREATE INDEX IF NOT EXISTS idx_detalle_pago_fecha_pago ON detalle_pago(fecha_pago);
